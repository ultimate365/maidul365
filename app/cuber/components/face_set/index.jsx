...
export default function FaceSet(props) {
  ...
  function solveCube() {
      ...
      let sideValue = colors.map((color) => {
        ...
        switch (color.toLowerCase()) {
          ...
          default:
            ...
            toast.error("Invalid Color to Side Conversion. Default side used");
        }
        return result;
      });
      return sideValue;
    ...
    //   props.handleClick();
    // }else{
    //   toast.error("No Cube data found.");
    // }
  }
  return (
    <div className="face__set--section flex__center--col">
      ...
      <div className="face__set--body flex__center--row">
        <ul className="color__value--container">
          ...
          <li className="color__value green">
            <b>g</b> = Green
          </li>
          <li className="color__value red">
            <b>r</b> = Red
          </li>
          <li className="color__value white">
            <b>w</b> = White
          </li>
          <li className="color__value yellow">
            <b>y</b> = Yellow
          </li>
          <li className="color__value orange">
            <b>o</b> = Orange
          </li>
          <li className="color__value blue">
            <b>b</b> = Blue
          </li>
        </ul>
      ...
      <button className="color__set--btn" onClick={solveCube}>
        Next
      </button>
    </div>
  );
