...
export default function CubeSolver() {
  ...
  let [pageVisibility, setPageVisibility] = useState([
    true,
    false,
    false,
    false,
  ...
  function handleFaceSet(e) {
    ...
    let value = e.target.value.toLowerCase(); // Get string typed by user on input field
    if (value.length <= 9) {
      let finalValue = [];
      ...
      toast.error("Input string is too long");
    }
  }
  // Start of solver
